        ...
        <form action="ManterPais.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <label for="populacao">Populaçãoo</label>
                    <input type="populacao" class="form-control" name="populacao" id="populacao" required placeholder="Digite a população do país">
                </div>
